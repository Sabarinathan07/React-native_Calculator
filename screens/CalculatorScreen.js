...
export default class CalculatorScreen extends React.Component {
  ...
  constructor(props) {
    ...
    //calc ah inga thaan initialize pandrom
    this.oc = global.swisscalc.lib.operatorCache;
    this.calc = new global.swisscalc.calc.calculator();

    // portrait and landscape change aagrathuku
      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            <CalcButton onPress={this.onClearPress} title="C" color="white" backgroundColor="red" />
  ...
  renderLandscape() {
    return (
      <View>
        <Text>Sorry for the inconvenience, Landscape is not supported!
            Please rotate Your Phone to view the calculator!!
        </Text>
      </View>
    )
  }
